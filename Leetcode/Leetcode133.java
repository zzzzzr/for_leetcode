...
class Leetcode.Node {
    public int val;
    public List<Leetcode.Node> neighbors;

    public Leetcode.Node() {
        val = 0;
        neighbors = new ArrayList<Leetcode.Node>();
    }

    public Leetcode.Node(int _val) {
        val = _val;
        neighbors = new ArrayList<Leetcode.Node>();
    }

    public Leetcode.Node(int _val, ArrayList<Leetcode.Node> _neighbors) {
        val = _val;
